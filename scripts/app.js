$(document).ready(function () {
    ...
    // Manually bootstrap in the second angular app
    angular.bootstrap(document.getElementById("studentAngularApp"), ['Hue']);
});


// Teacher app
var app = angular.module("HueHue", ["firebase", "ngAnimate"]);
// Student app
var appStu = angular.module("Hue", ["firebase", "ngAnimate"]);

appStu.controller("StudentHue", function ($scope, $firebaseObject, $firebaseArray) {
    console.log("loaded!");
...
app.controller("TeacherHue", function ($scope, $firebaseObject, $firebaseArray) {
